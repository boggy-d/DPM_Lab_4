...
public class Odometer implements TimerListener {
	...
	public Odometer (EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor, int INTERVAL, boolean autostart) {
		...
		this.y = 0.0;
		this.theta = 90.0;
		this.oldDH = new double[2]; //The old displacement and heading
		this.dDH = new double[2];	//New displacement and heading
	...
	private void getDisplacementAndHeading(double[] data) {
		...
		data[0] = (leftTacho * leftRadius + rightTacho * rightRadius) * Math.PI / 360.0; //To calculate displacement (linear velocity)(in rad)
		data[1] = (rightTacho * rightRadius - leftTacho * leftRadius) / width; //Calculate dTacho/width=sin(theta) (angular velocity)
	}
	...
	/*
	 * Utility method to make robot move forward/backward at a certain speed
	 */
	public void setSpeeds(int lSpeed, int rSpeed)
	{
